...
export const styles = StyleSheet.create({
    ...
    contentView:{flexDirection: 'column', width: '100%', padding:Spacing.Alternative, height: 126, justifyContent: 'space-between', borderWidth: 1, borderColor:Color.LightGray, borderTopEndRadius:Spacing.ExtraSmall,borderTopStartRadius:Spacing.ExtraSmall},

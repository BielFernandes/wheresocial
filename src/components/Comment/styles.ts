...
export const styles = StyleSheet.create({
    ...
    contentView:{flexDirection: 'row', width: '92%', height: Spacing.TripleExtraLarge*2 + 10, padding:Spacing.Alternative, alignItems:'flex-start' , borderWidth: 1, borderColor:'rgba(0, 0, 0, 0.20)', gap: Spacing.Base},
